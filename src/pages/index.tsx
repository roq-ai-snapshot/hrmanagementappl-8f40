  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR processes with HRManagementApplication - your partner in building a productive and harmonious workplace."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR processes with HRManagementApplication - your partner in building a productive and harmonious workplace.`}
            </Text>
            <Box
